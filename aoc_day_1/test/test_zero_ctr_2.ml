...
module Zero_ctr_2 = Aoc_1.Zero_ctr_2
module Harness = Cyclesim_harness.Make (Zero_ctr_2.I) (Zero_ctr_2.O)
...
let simple_testbench (sim : Harness.Sim.t) =
  ...
  let out_channel = Out_channel.create "/Users/pkarmehan/Desktop/HardCaml/aoc_day_1/test/hw_out_2.txt" in
...
let%expect_test "Register 4-bit test - count 0 to 15 and back" =
  Harness.run_advanced ~waves_config ~create:Zero_ctr_2.hierarchical simple_testbench;
  [%expect {| Saved waves to /tmp/test_zero_ctr_2_ml_Register_4_bit_test___count_0_to_15_and_back.vcd |}]
;;